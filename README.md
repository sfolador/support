# This package helps you to create a support page and manage the support requests.
...
```php
$support = new Simone Folador\Support();
echo $support->echoPhrase('Hello, Simone Folador!');
```
